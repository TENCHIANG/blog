...
// gcc -Wall -O3 /sdcard/Pictures/MemoryTools/mem.c -o /data/local/tmp/test/mem
// su -c '/data/local/tmp/test/mem -p com.tencent.lycqsh -a 82bb400e -o 3210'
